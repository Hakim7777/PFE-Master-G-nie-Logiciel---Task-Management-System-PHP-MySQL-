...
<!-- Info boxes -->
 <div class="col-12">
          <div class="card">
            <div class="card-body">
             Bienvenu <?php echo $_SESSION['login_name'] ?>!
            </div>
          </div>
  </div>
  <hr>
          ...
          <div class="col-12 col-sm-6 col-md-12">
            <div class="small-box bg-light shadow-sm border">
              <div class="inner">
                ...
                <p>Nombre des projets</p>
              </div>
              <div class="icon">
                <i class="fa fa-layer-group" style="color: #42ffad;"></i>></i>
              </div>
            </div>
          </div>
           <div class="col-12 col-sm-6 col-md-12">
            <div class="small-box bg-light shadow-sm border">
              <div class="inner">
                ...
                <p>Nombre des tâches </p>
              </div>
              <div class="icon">
                <i class="fa fa-tasks"style="color: #42ffad";></i>
              </div>
            </div>
          </div>
      </div>
