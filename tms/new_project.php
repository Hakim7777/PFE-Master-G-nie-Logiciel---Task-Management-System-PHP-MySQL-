...
<div class="col-lg-12">
	<div class="card card-outline card-primary">
          	...
          	<div class="col-md-6">
				<div class="form-group">
					...
					<select name="status" id="status" class="custom-select custom-select-sm">
						<option value="0" <?php echo isset($status) && $status == 0 ? 'selected' : '' ?>>En pause</option>
						<option value="3" <?php echo isset($status) && $status == 3 ? 'selected' : '' ?>>En attente</option>
						<option value="5" <?php echo isset($status) && $status == 5 ? 'selected' : '' ?>>Términé</option>
					</select>
				</div>
			</div>
		</div>
        ...
        <div class="row">
           ...
           <div class="col-md-6">
            <div class="form-group">
              <label for="" class="control-label">Gestionnaire des projets</label>
      ...
      <?php endif; ?>
          <div class="col-md-6">
            <div class="form-group">
              <label for="" class="control-label">Membres de l'équipe projet</label>
