			...
			<form action="" id="manage_user">
				...
				<div class="row">
					<div class="col-md-6 border-right">
						...
						<div class="form-group">
							...
							<select name="type" id="type" class="custom-select custom-select-sm">
								...
								<option value="2" <?php echo isset($type) && $type == 2 ? 'selected' : '' ?>>Gestionnaire de projet</option>
					...
					<div class="col-md-6">
						...
						<div class="form-group">
							<label class="label control-label">Confirmation de mot de passe</label>
...
<script>
	$('[name="password"],[name="cpass"]').keyup(function(){
		...
		if(cpass == '' ||pass == ''){
			...
			if(cpass == pass){
				$('#pass_match').attr('data-status','1').html('<i class="text-success">Mot de passe correspondant</i>')
			}else{
