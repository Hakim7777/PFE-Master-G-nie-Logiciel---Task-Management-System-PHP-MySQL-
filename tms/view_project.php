...
<div class="col-lg-12">
			...
			<div class="callout callout-info">
				<div class="col-md-12">
					<div class="row">
						<div class="col-sm-6">
							<dl>
								<dt><b class="border-bottom border-primary">Nom de Projet</b></dt>
						...
						<div class="col-md-6">
							...
							<dl>
								<dt><b class="border-bottom border-primary">Gestionnaire des projets</b></dt>
								<dd>
		...
		<div class="col-md-4">
			<div class="card card-outline card-primary">
				<div class="card-header">
					<span><b>Les Membres d'équipe :</b></span>
	...
	<div class="row">
		<div class="col-md-12">
			<div class="card">
				<div class="card-header">
					<b>Progression/Activité des membres</b>
					<div class="card-tools">
